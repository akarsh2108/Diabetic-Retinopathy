# -*- coding: utf-8 -*-
"""
Created on Tue May 18 17:55:26 2021
...
def predict():
    ...
    if(path==""):
        tkinter.messagebox.showinfo("Image Not Selected","Please Select Image \nTo get the Prediction")
    else:
        print("[INFO] loading network...")
        model =load_model('./model_retina.h5')

        labels = ['Diabetic','Normal'] #These labels will be used for showing output
        start_point = (30,30)
        end_point = (1000, 300)
        thickness = -1
...
root = Tk()
root.title("GUI : Diabetic Eye Detection")
...
Title_Label = Label(Tops,font=('Comic Sans MS',20,'bold'),text = " 'Diabetic Eye Prediction' ",pady=9,bg= 'white',fg='red',justify ="center")
...
Label_1 =Label(MainFrame, font=('lato black', 17,'bold'), text="Detect Diabetic Eye using Retina Image",padx=2,pady=2, bg="white",fg ="black")
...
Label_9 =Button(MainFrame, font=('arial', 19,'bold'), text="  Detect ",padx=2,pady=2, bg="blue",fg = "white",command=predict)
